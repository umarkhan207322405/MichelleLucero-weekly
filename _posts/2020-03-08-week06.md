...
---
All of us decided to run all of next.js's tests. The running time varied from 80-210 minutes. Fortunately, I was the one who "waited" 80 minutes. During that time, I walked my dog for 20 minutes, made some tea, and chatted with teammates on the worrisome implications on our overworked machines :skull:. 

Selecting Issues
---
First, we plan on browsing the issues that contain the "good first issue" tag.
